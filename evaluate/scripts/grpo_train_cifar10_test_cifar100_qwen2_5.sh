...
GPUS="0,1,2,3"
BATCH_SIZE=512
BASE_RUN_NAME="grpo_train_cifar10_test_cifar100_qwen2_5"
...
for step in {400..7200..400}; do
  ...
  MODEL_NAME="/public/home/group_ucb/dyk6208/VLM_forgetting/train/fully_finetuning_grpo/checkpoints/GRPO-Qwen2.5-VL-3B-Instruct-cifar10/checkpoint-${step}"
