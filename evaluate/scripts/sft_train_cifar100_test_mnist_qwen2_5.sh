...
GPUS="0,1,2,3"
BATCH_SIZE=512
BASE_RUN_NAME="sft_train_cifar100_test_mnist_qwen2_5"
WANDB_PROJECT="vlm-forgetting"
WANDB_GROUP=$BASE_RUN_NAME

# Finetuned checkpoints: 200 ~ 1800
for step in {1000..12000..1000}; do
  RUN_NAME="${step}_steps"
  MODEL_NAME="/public/home/group_ucb/dyk6208/LLaMA-Factory/saves/qwen2_5_vl-3b/full/cifar100_sft/checkpoint-${step}"
