...
GPUS="0,1,2,3"
BATCH_SIZE=512
BASE_RUN_NAME="grpo_train_cifar100_test_cifar100_qwen2_5"
WANDB_PROJECT="vlm-forgetting"
WANDB_GROUP=$BASE_RUN_NAME

# Finetuned checkpoints: 200 ~ 1800
for step in {400..7200..400}; do
  RUN_NAME="${step}_steps"
  MODEL_NAME="/public/home/group_ucb/dyk6208/VLM_forgetting/train/fully_finetuning_grpo/checkpoints/GRPO-Qwen2.5-VL-3B-Instruct-cifar100/checkpoint-${step}"
